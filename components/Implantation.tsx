                   ...
                   <div className="flex items-center bg-slate-100 rounded-lg p-0.5 border border-slate-200 relative">
                       ...
                       {isManualMode && (
                           <>
                               ...
                               {/* LAYOUT ASSISTANTS (NEW) */}
                               <div className="flex items-center gap-1">
                                   <button 
                                       onClick={() => applyLayoutPattern('U')}
                                       className="p-1.5 rounded-md transition-colors text-slate-500 hover:text-indigo-600 hover:bg-white"
                                       title="Arranger en U (Lignes)"
                                   >
                                       <Columns className="w-3.5 h-3.5" />
                                   </button>
                                   <button 
                                       onClick={() => applyLayoutPattern('GRID')}
                                       className="p-1.5 rounded-md transition-colors text-slate-500 hover:text-indigo-600 hover:bg-white"
                                       title="Arranger en Grille"
                                   >
                                       <LayoutGrid className="w-3.5 h-3.5" />
                                   </button>
                                   <button 
                                       onClick={() => applyLayoutPattern('CIRCLE')}
                                       className="p-1.5 rounded-md transition-colors text-slate-500 hover:text-indigo-600 hover:bg-white"
                                       title="Arranger en Cercle"
                                   >
                                       <CircleDashed className="w-3.5 h-3.5" />
                                   </button>
                                   <button 
                                       onClick={() => applyLayoutPattern('LINE')}
                                       className="p-1.5 rounded-md transition-colors text-slate-500 hover:text-indigo-600 hover:bg-white"
                                       title="Arranger en Ligne Droite"
                                   >
                                       <AlignIcon className="w-3.5 h-3.5 rotate-90" />
                                   </button>
                               </div>
